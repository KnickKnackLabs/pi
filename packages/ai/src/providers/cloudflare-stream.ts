import type { Api, IdentifiedProviderStreams, Model, ProviderEnv } from "../types.ts";
 ...
 */
export function cloudflareStreams<TApi extends Api>(
	streams: IdentifiedProviderStreams<TApi>,
