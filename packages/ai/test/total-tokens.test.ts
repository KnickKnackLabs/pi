...
describe("totalTokens field", () => {
	...
	describe.skipIf(!hasCloudflareAiGatewayCredentials() || !cloudflareAiGatewayModel)("Cloudflare AI Gateway", () => {
		it(
			"catalog completions model should return totalTokens equal to sum of components",
			{ retry: 3, timeout: 60000 },
			async () => {
