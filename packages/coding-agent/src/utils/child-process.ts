...
const EXIT_STDIO_GRACE_MS = 1000;
 ...
 * measured from `exit`, or output still being written past that deadline is silently
 * lost (earendil-works/pi#5303). Instead, after `exit` we wait for the pipes to fall idle:
