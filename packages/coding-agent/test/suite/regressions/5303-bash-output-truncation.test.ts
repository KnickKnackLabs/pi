 ...
 * resolved the wait, and any output written after it elapsed was binned. In
 * practice every git commit whose pre-commit hook runs lint-staged came back
 * truncated mid-listr2 output, read by the model as a hang.
 *
